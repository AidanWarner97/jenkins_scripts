...
if [[ " $google_devices " == *" $device "* ]]; then
    ...
    rsync -avz /home/shared/11-source/vendor/gms/ /home/shared/11-build/vendor/gms/
    echo "Syncing pixel style from source"
    rsync -avz /home/shared/11-source/vendor/pixel-style/ /home/shared/11-build/vendor/pixel-style/
